...
int mgmt_wifi_frame_recv(int ap_index, wifi_frame_t *frame)
{
    ...
    queue_ret = push_event_to_ctrl_queue((frame_data_t *)&wifi_mgmt_frame,
        (sizeof(wifi_mgmt_frame) + frame->len), wifi_event_type_hal_ind,
        wifi_event_hal_mgmt_frames, NULL);
    wifi_util_info_print(WIFI_CTRL,
